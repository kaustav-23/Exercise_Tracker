...
public class WalkActivity extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnStopTracking = (Button) findViewById(R.id.btn_walk_stop);
        btnStartTracking = (Button) findViewById(R.id.btn_walk_start);
        btnStopTracking.setOnClickListener(stopListener);
        btnStartTracking.setOnClickListener(startListener);


        mStepsSinceReboot =
                (TextView) findViewById(R.id.tv_walk_stepsTaken);
        caloriesBurned = (TextView) findViewById(R.id.tv_walk_kcal);
    ...
    private View.OnClickListener startListener = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            if (isSensorPresent) {
                mSensorManager.registerListener(WalkActivity.this, mSensor,
    ...
    private View.OnClickListener stopListener = new View.OnClickListener() {
        public void onClick(View v) {
            if (isSensorPresent) {
                mSensorManager.unregisterListener(WalkActivity.this);
            }
            isTracking = false;
            running = false;
